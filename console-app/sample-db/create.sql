/*                                                                        */
/*              InstSampleDB.SQL - Creates the SampleDB database                  */
/*                                                                        */
/*
...
raiserror('Beginning InstSampleDB.SQL at %s ....',1,1,@dttm) with nowait

GO

if exists (select * from sysdatabases where name='SampleDB')
begin
  raiserror('Dropping existing SampleDB database ....',0,1)
...
raiserror('Creating SampleDB database....',0,1)
go
/*
...
if db_name() <> 'SampleDB'
   raiserror('Error in InstSampleDB.SQL, ''USE SampleDB'' failed!  Killing the SPID now.'
            ,22,127) with log
...
BEGIN
  exec sp_dboption 'SampleDB','trunc. log on chkpt.','true'
  exec sp_dboption 'SampleDB','select into/bulkcopy','true'
END
ELSE ALTER DATABASE [SampleDB] SET RECOVERY SIMPLE WITH NO_WAIT
GO
...
'This is sample text data for New Moon Books, publisher 0736 in the SampleDB database. New Moon Books is located in Boston, Massachusetts.
...
'This is sample text data for Binnet & Hardley, publisher 0877 in the SampleDB database. Binnet & Hardley is located in Washington, D.C.
...
'This is sample text data for Algodata Infosystems, publisher 1389 in the SampleDB database. Algodata Infosystems is located in Berkeley, California.
...
'This is sample text data for Five Lakes Publishing, publisher 1622 in the SampleDB database. Five Lakes Publishing is located in Chicago, Illinois.
...
'This is sample text data for Ramona Publishers, publisher 1756 in the SampleDB database. Ramona Publishers is located in Dallas, Texas.')
...
'This is sample text data for GGG&G, publisher 9901 in the SampleDB database. GGG&G is located in M�nchen, Germany.')
...
'This is sample text data for Scootney Books, publisher 9952 in the SampleDB database. Scootney Books is located in New York City, New York.')
...
'This is sample text data for Lucerne Publishing, publisher 9999 in the SampleDB database. Lucerne publishing is located in Paris, France.
...
declare @dttm varchar(55)
select  @dttm=convert(varchar,getdate(),113)
raiserror('Ending InstSampleDB.SQL at %s ....',1,1,@dttm) with nowait
